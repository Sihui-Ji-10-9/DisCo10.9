...
--train_yaml /HOME/HOME/jisihui/VITON/try1/tsv/val.yaml \
--val_yaml /HOME/HOME/jisihui/VITON/try1/tsv/val.yaml \
...
--eval_save_filename /home/nfs/jsh/DisCo/eval/eval_pt1.2_changecloth_try1