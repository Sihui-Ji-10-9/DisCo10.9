PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python AZFUSE_USE_FUSE=0 QD_USE_LINEIDX_8B=0 NCCL_ASYNC_ERROR_HANDLING=0 CUDA_VISIBLE_DEVICES='2,3' python -m torch.distributed.launch --nproc_per_node=2 --master_port=12310 finetune_sdm_yaml.py \
...
--local_train_batch_size 64 --local_eval_batch_size 64 --log_dir exp/pretrain_3.0_2 \
...
--combine_clip_local --combine_use_mask --viton_hd --densepose \
