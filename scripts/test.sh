...
--local_train_batch_size 64 --local_eval_batch_size 64 --log_dir exp/test \
--epochs 100 --deepspeed --eval_step 200 --save_step 200 --gradient_accumulate_steps 1 \
--learning_rate 8e-4 --fix_dist_seed --loss_target "noise" \
...
--combine_clip_local --combine_use_mask --viton_hd --base \
