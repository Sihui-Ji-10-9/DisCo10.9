...
# 文件夹路径
folder_path = '/home/nfs/jsh/DisCo/eval/eval_pt3.0_1_dino_hd_try4.0_fix_fat_vedio3/pred_image'  # 替换为实际的文件夹路径
...
# 设置 GIF 参数
gif_path = '/home/nfs/jsh/DisCo/eval/eval_pt3.0_1_dino_hd_try4.0_fix_fat_vedio3/pred_image/output.gif'  # 替换为实际的输出路径
