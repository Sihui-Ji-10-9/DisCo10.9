...
--cf config/ref_attn_clip_combine_controlnet_attr_pretraining/coco_S256_xformers_tsv_strongrand5.1_mlonly.py \
--do_train --root_dir /home/nfs/jsh/DisCo \
--local_train_batch_size 64 --local_eval_batch_size 64 --log_dir exp/pretrain_5.1_mlonly_dino_hd_resume \
