...
--train_yaml /HOME/HOME/jisihui/VITON-hd-resized/try1.0_slim/tsv/val.yaml \
--val_yaml /HOME/HOME/jisihui/VITON-hd-resized/try1.0_slim/tsv/val.yaml \
--unet_unfreeze_type "all" \
--ref_null_caption False \
--combine_clip_local --combine_use_mask --viton_hd \
--stage1_pretrain_path /home/nfs/jsh/DisCo/exp/pretrain_3.0_3/8499.pth/mp_rank_00_model_states.pt \
--eval_save_filename /home/nfs/jsh/DisCo/eval/eval_pt3.0_3_hd_slim