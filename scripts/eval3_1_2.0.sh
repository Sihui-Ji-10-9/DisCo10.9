...
--cf config/ref_attn_clip_combine_controlnet_attr_pretraining/coco_S256_xformers_tsv_strongrand6.py \
...
--train_yaml /home/nfs/jsh/HOME/VITON-hd-resized/try3.0/tsv/val2.yaml \
--val_yaml /home/nfs/jsh/HOME/VITON-hd-resized/try3.0/tsv/val2.yaml \
...
--eval_save_filename /home/nfs/jsh/DisCo/eval/eval_pt3.0_1_dino_hd_try2.0_fix_big_vedio4_