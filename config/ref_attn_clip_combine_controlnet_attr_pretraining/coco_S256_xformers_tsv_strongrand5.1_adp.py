...
from config import *
from config.ref_attn_clip_combine_controlnet_attr_pretraining.net4_base_ipadapter import Net, inner_collect_fn
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = 'dataset/coco_controlnet_t2i_imagevar_combine_tsv_strongrand_try.py'
