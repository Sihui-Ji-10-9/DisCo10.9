...
class DualTransformer2DModel(nn.Module):
    ...
    def forward(
        ...
        for i in range(2):
            ...
            encoded_state, o_refer_hs = self.transformers[transformer_index](
                input_states,
        ...
        if not return_dict:
            return (output_states, output_refer_states)

        return Transformer2DModelOutput(sample=output_states, hidden_states=output_refer_states)
