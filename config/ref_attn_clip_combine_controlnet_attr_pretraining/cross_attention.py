...
class CrossAttention(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None,
                refer_hs=None, **cross_attention_kwargs):
...
class CrossAttnProcessor:
    def __call__(
        ...
        o_refer_hs = hidden_states
        if refer_hs is not None:
            hidden_states = torch.cat([hidden_states, refer_hs], dim=1)
        ...
        return hidden_states, o_refer_hs
